...
drawing_sprite = global.spr_flicky
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
applies_to=self
...
switch state
{
    case "normal":
    {
        ...
        targetx = instance_nearest(x,y,obj_tunnel).x;

        if y > instance_nearest(x,y,obj_tunnel).y
        targety = instance_nearest(x,y,obj_tunnel).y;
        else if y < instance_nearest(x,y,obj_tunnel).y
        targety = room_height;
