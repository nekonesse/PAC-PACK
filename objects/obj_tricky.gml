...
drawing_sprite = global.spr_tricky
/*"/*'/**//* YYD ACTION
lib_id=1
action_id=603
applies_to=self
...
switch state
{
    case "normal":
    {
        ...
        if point_distance(x,y,instance_nearest(x,y,obj_pacman).x,instance_nearest(x,y,obj_pacman).y) < 160
        {
            targetx = 2 * x-obj_pacman.x;
            targety = 2 * y-obj_pacman.y;
        }
